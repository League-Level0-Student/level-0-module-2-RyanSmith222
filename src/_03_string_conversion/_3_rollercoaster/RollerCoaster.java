...
String heightToRide = JOptionPane.showInputDialog(null, "Please enter your height in inches.");	
int heightToRideInt = Integer.parseInt(heightToRide);
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		JOptionPane.showMessageDialog(null,  "Hurray! You are tall enought to ride the coaster alone!");
			}
			else {
